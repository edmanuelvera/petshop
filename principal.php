...
<head>
	...
	<title>Menu</title>
	<link rel="stylesheet" href="../proyecto/principal/css/estilosmenu.css">
	...
	<header>
		<div class="contenido_menu">
			...
			<div class="menu">
				...
				<div id="opaco"></div>
				<nav id="nav">
					<img src="../proyecto/principal/image/garrita2.png">
					<ul>
						<li><a href="#" id="selected">Inicio</a></li>
						<li><a href="../proyecto/sobrenosotros/sobrenosotros.php">Sobre nosotros</a></li>
						<li><a href="#">Animales</a></li>
						<li><a href="../proyecto/login/index.php">Acceder</a></li>
					</ul>
				</nav>
			</div>
		</div>
	...
	<div class="contenido_todo">
			...
			<div class="slide">
				<div class="objetoslide">
					<img src="../proyecto/slider/images/img1.png">
				</div>
				<div class="objetoslide">
					<img src="../proyecto/slider/images/img2.png">
				</div>
				<div class="objetoslide">
					<img src="../proyecto/slider/images/img3.png">
				</div>
			</div>
	...
	<div class="documento_contenido">
		<div class="texto_contenido">
			...
			<div class="imagen_fondo">
				<img src="../proyecto/principal/image/doki.png">
			</div>
	</div>
</div>
...
<div class="cuerpodearticulos">
	<div class="cajadearticulo">
		<img src="../proyecto/principal/image/art1.png">
		<hr>
		<h2>Perrito</h2><hr><br>
		<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quas, corporis.</p>
	</div>
    <div class="cajadearticulo">
		<img src="../proyecto/principal/image/art2.png">
		<hr>
		<h2>Gatito</h2><hr><br>
		<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quas, corporis.</p>
	</div>
	<div class="cajadearticulo">
		<img src="../proyecto/principal/image/art3.png">
		<hr>
		<h2>Otros</h2><hr><br>
		<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quas, corporis.</p>
	</div>
...
<head>
	...
	<title>Footer</title>
	<script src="https://kit.fontawesome.com/68bd6542c8.js" crossorigin="anonymous"></script>
	<link rel="stylesheet" href="../proyecto/footer/css/estilos.css">
</head>
<body>
	<footer>
		<div class="fondo_footer">
			<div class="caja_footeer">
				<div class="imagen_defooter">
					<img src="../proyecto/footer/images/wofwof.png">
...
<!-- JAVA SCRIPT!-->
	...
	<script src="../proyecto/principal/js/funciones.js"></script>
</body>
</html>